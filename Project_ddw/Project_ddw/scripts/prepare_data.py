...
def prepare_data(
    ...
    subtomo_extraction_strides: Annotated[
        Optional[List[int]],
        typer.Option(
            help="List of 2 integers specifying the 2D Strides used for subtomogram extraction. If set to None, stride 'subtomo_size' is used in both directions. Smaller strides result in more sub-tomograms being extracted."
        ),
    ] = None,
